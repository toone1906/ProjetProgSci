...
Calcul la vitesse des stations GNSS à partir d'un modèle, puis convertit 
  ...
  Args:
      pmm (pandas.DataFrame):Table des paramètres de plaques. Contient en particulier:
          - 'Name' : identifiant de plaque (clé de jointure)
          - 'Omega_x', 'Omega_y', 'Omega_z' : composantes de ω en mas/yr
      ITRF (pandas.DataFrame): Table des stations. Contient en particulier :
  ...
  Returns:
      pandas.DataFrame: Copie de `ITRF` enrichie avec :
