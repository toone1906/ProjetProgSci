...
if __name__ == "__main__":
    ...
    with tqdm(total=3, desc="Chargement fichiers") as pbar:
        ...
        pmm_itrf = pd.read_csv("data/pmm_itrf.txt",sep=r'\s+',skiprows=4,names=["Plate", "Name", "NS","Omega_x", "Omega_y","Omega_z","Omega","WRMS","Sigma_y","s_Omega_x","s_Omega_y","s_Omega_z","s_Omega"],engine='c' )
        pbar.update(1)
